							...
							<svg width="100" height="50" viewBox="0 0 100 50" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<defs>
									<linearGradient id="paint0_linear" x1="0" y1="25" x2="100" y2="25" gradientUnits="userSpaceOnUse">
										<stop stop-color="#2C8FEA" />
										<stop offset="1" stop-color="#2365DF" />
									</linearGradient>
								</defs>
							</svg>
						</Link> */}
				...
				<div className="navbar-end">
					...
					<label
						...
						<div className="HAMBURGER-ICON space-y-2.5 ml-5">
							<div className={`h-0.5 w-8 bg-primary ${isNavOpen ? 'hidden' : ''}`} />
							<div className={`h-0.5 w-8 bg-primary ${isNavOpen ? 'hidden' : ''}`} />
							<div className={`h-0.5 w-8 bg-primary ${isNavOpen ? 'hidden' : ''}`} />
						</div>
						<div className={`absolute block h-0.5 w-8 animate-pulse bg-primary ${isNavOpen ? "" : "hidden"}`}
					...
					<div className="dropdown dropdown-end">
						<div tabIndex={0} className="btn btn-square btn-ghost text-right mr-4 hover:scale-125">
						...
						<ul tabIndex={0} className="p-2 shadow menu dropdown-content bg-secondary rounded-box sm:w-52">
							<li>
